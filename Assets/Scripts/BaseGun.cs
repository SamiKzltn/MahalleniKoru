...
public abstract class BaseGun : MonoBehaviour
{
    ...
    [SerializeField] protected KeyCode m_currentWeapon1 = KeyCode.Alpha1;
    [SerializeField] protected KeyCode m_currentWeapon2 = KeyCode.Alpha2;
    ...
    protected virtual void InputControl()
    {
        ...
        if (Input.GetKey(m_currentWeapon1))
        {
            WeaponChange();
        }
        if (Input.GetKey(m_currentWeapon2))
        {
            WeaponChange();
        }
    }
